...
//Runnable Interface supports run() method
	...
	public void run(){	//new Thread of server will start executing from run method
		// code for communication with client using respective connection socket
		try{
	...
	public static void main(String[] args) throws Exception{
		...
		// for every client who calls accept() method create a thread to serve him via its connection socket
